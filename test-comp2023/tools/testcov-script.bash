...
podman run --rm -i -t --volume=/mnt/c/Users/bguil/Documents/GitHub/Map2Check:/release --workdir /release registry.gitlab.com/sosy-lab/benchmarking/competition-scripts/user:latest bash
cd release
